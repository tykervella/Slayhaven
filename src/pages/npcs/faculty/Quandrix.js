    ...
    <Container >
      <Row className="infoBox1" >
        ...
        <Col md={6} sclassName="float-container-dean">
          ...
          <h6>
            Neutral, owlin, Quandrix professor of theory, he/him 
          </h6>
          <p>
      ...
      <Row className="infoBox2">
        ...
        <Row>
          <Col md={6} className="float-left-order float-container">
            ...
            <h6>Neutral Good, awakened brown bear, Quandrix professor of substance, he/him</h6>
            <p>
        ...
        <Row>
          ...
          <Col md={6} className="float-container">
            ...
            <h6>Lawful Neutral, human, Quandrix professor of theory, she/her</h6>
            <p>
