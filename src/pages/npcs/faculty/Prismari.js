    ...
    <Container >
      <Row className="infoBox1" >
        ...
        <Col md={6} className="float-container-dean">
          ...
          <p>
            Uvilda believes that good art comes from the head. To them, carefully measured strokes and deliberate object placement make the difference between fully realized art and a total mess. If Dean Nassari interrupts their careful work with bombastic expressions one more time, Uvilda is prepared to enroll in Quandrix to learn how to shrink Nassari.
          </p>
        </Col>
        <Col md={6} className="float-container-dean">
          <img
          ...
          <h6>
            Chaotic Good, genasi, Prismari professor of expression, they/them
          </h6>
          <p>
      ...
      <Row className="infoBox2">
        ...
        <Row>
          ...
          <Col md={6} className="float-container">
            ...
            <h6>Chaotic Good, genasi, Prismari professor of perfection, she/her </h6>
            <p>
        ...
        <Row>
          <Col md={6} className="float-left-order float-container">
            ...
            <h6>Chaotic Neutral, human, Prismari professor of expression, he/they</h6>
            <p>
              As soon as Zaffai came of age, their parents sent him to Strixhaven, assuring them their budding musical genius deserved the finest instruction in the world. (In truth, though he did possess prodigious talent, they were also growing tired of their house being randomly struck by lightning or engulfed in cyclones whenever he practiced.) Even as he flourished as both mage and musician, they discovered a new aptitude: conducting.
            </p>
            <p>
        ...
        <Row>
          ...
          <Col md={6} className="float-container">
            ...
            <h6>Lawful Good, human, Prismari professor of expression, he/him</h6>
            <p>
