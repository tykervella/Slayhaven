    ...
    <Router style={{ backgroundColor: "var(--darkest)" }}>
      <div className="flex-column justify-flex-start min-100-vh" style={{ backgroundImage: `url(${backgroundIMG})` }}>
        ...
        <div className="container" style={{ marginBottom: "2.5%", width: "82.5%" }}>
          <Routes>
            <Route
              path="/slayhaven" // Set "/slayhaven" as the base path
              element={
                <>
                  ...
                  <Route path="/lorehold" element={<Lorehold />} />
                  <Route path="/prismari" element={<Prismari />} />
                  <Route path="/quandrix" element={<Quandrix />} />
                  <Route path="/silverquill" element={<Silverquill />} />
                  <Route path="/witherbloom" element={<Witherbloom />} />

                  {/* Faculty Routes  */}
                  <Route path="/npcs/faculty/central" element={<CentralFaculty />} />
                  <Route path="/npcs/faculty/lorehold" element={<LoreholdFaculty />} />
                  <Route path="/npcs/faculty/prismari" element={<PrismariFaculty />} />
                  <Route path="/npcs/faculty/quandrix" element={<QuandrixFaculty />} />
                  <Route path="/npcs/faculty/silverquill" element={<SilverquillFaculty />} />
                  <Route path="/npcs/faculty/witherbloom" element={<WitherbloomFaculty />} />
