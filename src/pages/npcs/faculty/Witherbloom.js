...
import Lang from '../../../components/images/characters/faculty/wb-Lang.png'
    ...
    <Container >
      <Row className="infoBox1" >
        ...
        <Col md={6} style={{display:"flex", flexDirection:"column", alignItems:"center"}}>
          ...
          />
          <h4>Lisette, Dean of the Root</h4>
          <h6>
            Neutral Good, human, Witherbloom professor of growth
          </h6>
          <p>
        ...
        <Col md={6} style={{display:"flex", flexDirection:"column", alignItems:"center"}}>
          ...
          />
          <h4> Valentin, Dean of the Vein </h4>
          <h6>
            Neutral, vampire, Witherbloom professor of shadow 
          </h6>
          <p>
            Dean Valentin is ancient and drinks the blood of living creatures throughout the bayou. Valentin is a kind of sangromancer—he receives visions from the blood he consumes, which he uses to learn things about a creature or place. He has no qualms about exploiting the bayou’s creatures for personal gain.
          </p>
          <p>
      ...
      <Row className="infoBox2"> 
        ...
        <Row>
          ...
          <Col md={6} style={{display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center"}}>
            <h4>Verelda Lang, Arcano-Biologist</h4>
